...
a2 = sigmoid(Theta1' * a1); % Theta1 is of dimension l2 X (n + 1), then a2 becomes of dimension l2 X m, where l2 = number of unit is layer 2 |
                            % Theta1 = 25 X 401, a1 = 5000 X 401 => a2 = 25 X 5000
